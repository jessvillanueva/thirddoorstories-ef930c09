const socialLinks = [
  {
    label: "X (Twitter)",
    href: "https://x.com/jayveesme?s=21&t=H9bT4zQzXUD2JhdElngBRQ",
    icon: (
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@thirddoorstories",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/jayveesme/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: "Patreon",
    href: "https://www.patreon.com/cw/thirddoorstories",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/jayveesdotme",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        ...
        <div className="flex items-center justify-center gap-5">
          {socialLinks.map((social) => (
            <a
              ...
              className="text-foreground/[0.35] hover:text-primary transition-colors"
